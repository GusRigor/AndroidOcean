...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://opiniaobomvaleapena.com.br/imagens/carregador-portatil-power-bank-pokebola-pokemon-go.png"
        ...
        call.enqueue(object : Callback<PokemonApiResult> {
            ...
            override fun onFailure(call: Call<PokemonApiResult>, t: Throwable) {
                tvResultado.text = "Erro ao carregar a lsita de pokémons"
